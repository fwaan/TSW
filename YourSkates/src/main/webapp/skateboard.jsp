...
if(prodotti == null){
    RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/ProductControl?action=skateboard");
...
<script>
    function updateImage(color) {
        ...
        if (color === 'nero') {
            imgElement.src = 'immagini/skateboard.png';
        } else {
            imgElement.src = 'immagini/skateboard_' + color + '.png';
        }
    }
...
<div class="container">
    ...
    <div class="form-container">
        <form action="ProductControl?action=addCartSkateboard" method="post">
            <p class="image-caption2">Skateboard</p>
